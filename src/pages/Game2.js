...
export default function Game2() {
  ...
  useEffect(() => {
    ...
    if (timeLeft === 0) {
      ...
      setTimeUp(true);
      setShowModal(true); // 🔥 show modal instead of redirect
      return;
    }
      ...
      >
        ...
        >
          ...
          <p style={{ margin: "8px 0 0", color: "#7a7a7a", fontSize: 15 }}>
            Look at the image and choose the correct number of kavum
          </p>
        </div>
        ...
        {!startClicked && (
          ...
          >
            ...
            >
              Look carefully at the image and choose the correct number of kavum
